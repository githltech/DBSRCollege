  ...
  const highlights = [
    {
      ...
      description: "LNCT Group of Colleges has Best Infrastructure with State-of-the-Art laboratories, Latest Machines and Smart Classrooms with A/V facility.",
      icon: "🏢",
    },
    {
    ...
    },
    {
      ...
      description: "Unbeatable Record Placement of Central India with 1800+ Offers by 40 Companies. Closed Campus only for LNCT Group of Colleges.",
      icon: "🏆",
    },
    {
            ...
            {highlights.map((highlight, index) => (
              <div key={index} className="flex flex-col space-x-2">
                ...
                <div className='text-center sm:text-left mt-2'>
                  ...
                  <p className=" mt-2 text-xs font-semibold">{highlight.description}</p>
                </div>
              </div>
            ))}
          </div>
